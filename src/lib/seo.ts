 ...
 * is why the people database holds the links at all (see
 * docs/content-model.md). Most guests still have nothing but a name, and a
 * Person with only a name is still worth emitting: it names the speaker of the
 * event. */
