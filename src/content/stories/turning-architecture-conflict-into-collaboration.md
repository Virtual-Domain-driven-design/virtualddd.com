...
curatedHeuristics: ["run-personal-retrospectives-close-design-tensions", "collect-friction-evidence-before-escalating-boundary-problems", "surface-assumptions-before-comparing-solutions", "translate-gut-resistance-into-assumptions-risks"]
focusKeyphrase: "architecture conflict collaboration"
seoTitle: "When Opinions Clash: Turning Architecture Conflict into Collaboration"
seoMetadescription: "Laïla Bougria shares how to turn clashing opinions into productive architecture decisions — from reframing problems before solutions to personal retrospectives that build evidence, not arguments."
