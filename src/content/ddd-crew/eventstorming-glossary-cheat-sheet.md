...
contributors:
  ...
  - { name: "kdmsnr", url: "https://github.com/kdmsnr" }
  - { name: "pimsmeets", url: "https://github.com/pimsmeets" }
...
![Core Concepts](./_assets/eventstorming-glossary-cheat-sheet/core-concepts.jpg)
...
![Example big picture](./_assets/eventstorming-glossary-cheat-sheet/big-picture.jpg)
...
![Pivotal Events](./_assets/eventstorming-glossary-cheat-sheet/pivotal-events.PNG)
...
![Boundaries](./_assets/eventstorming-glossary-cheat-sheet/boundaries.PNG)
*Source: https://leanpub.com/ddd_first_15_years – Discovering Bounded Contexts with EventStorming — Alberto Brandolini*

![Big picture tools](./_assets/eventstorming-glossary-cheat-sheet/big-picture-tools.jpg)
...
![Emergent bounded context](./_assets/eventstorming-glossary-cheat-sheet/emergent-bounded-contexts.PNG)
*Source: https://leanpub.com/ddd_first_15_years – Discovering Bounded Contexts with EventStorming — Alberto Brandolini*
...
![Process modelling](./_assets/eventstorming-glossary-cheat-sheet/process-modelling.PNG)
...
![Process design tools](./_assets/eventstorming-glossary-cheat-sheet/process-design.jpg)
...
![Domain Event](./_assets/eventstorming-glossary-cheat-sheet/domain-event.png)
*Source: https://leanpub.com/introducing_eventstorming*
...
![Start EventStorming](./_assets/eventstorming-glossary-cheat-sheet/start-es.png)
*Source: https://leanpub.com/introducing_eventstorming*
