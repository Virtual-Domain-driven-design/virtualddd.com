...
description: "Design & visualise the flow of commands, events, and queries between your bounded contexts"
...
![Message Flow Just Messages](./_assets/domain-message-flow-modelling/just-messages-no-contents.jpg)
...
![Example Message Flow](./_assets/domain-message-flow-modelling/domain-message-flow.jpg "An Example Domain Message Flow")
