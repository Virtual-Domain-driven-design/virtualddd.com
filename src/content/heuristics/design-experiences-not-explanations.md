---
title: "Design experiences instead of explaining more"
slug: "design-experiences-not-explanations"
status: "Published"
...
- When participants withhold consent and demand command-and-control certainty—experiential learning fails without willingness to risk uncertainty.
- In environments requiring immediate, measurable deliverables where organizations refuse any ambiguity in outcomes.

## Variations

- For remote sessions, use digital collaborative tools like Miro for iceberg modeling to simulate hands-on system redesign.
- For technical workshops, pair with EventStorming to let teams experience domain events driving architectural shifts.
- When working with executives, frame short storytelling experiences around high-level outcomes rather than deep modeling.
